...
class AdresseResourceIT {
    ...
    private static final String DEFAULT_CODE_TYPE_ADRESSE = "AAAAAAAAAA";
    private static final String UPDATED_CODE_TYPE_ADRESSE = "BBBBBBBBBB";
    ...
    public static Adresse createEntity() {
        return new Adresse()
            ...
            .codeTypeAdresse(DEFAULT_CODE_TYPE_ADRESSE)
    ...
    public static Adresse createUpdatedEntity() {
        return new Adresse()
            ...
            .codeTypeAdresse(UPDATED_CODE_TYPE_ADRESSE)
    ...
    @Test
    @Transactional
    void checkCodeTypeAdresseIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        adresse.setCodeTypeAdresse(null);
    ...
    void getAllAdresses() throws Exception {
        ...
        restAdresseMockMvc
            ...
            .andExpect(jsonPath("$.[*].codeTypeAdresse").value(hasItem(DEFAULT_CODE_TYPE_ADRESSE)))
    ...
    void getAdresse() throws Exception {
        ...
        restAdresseMockMvc
            ...
            .andExpect(jsonPath("$.codeTypeAdresse").value(DEFAULT_CODE_TYPE_ADRESSE))
