...
public class Adresse implements Serializable {
    ...
    @NotNull
    @Column(name = "code_type_adresse", nullable = false)
    ...
    @Column(name = "nombre_courriers_pnd")
    ...
    public Adresse codeTypeAdresse(String codeTypeAdresse) {
        this.setCodeTypeAdresse(codeTypeAdresse);
        return this;
    }
    ...
    public String toString() {
        return "Adresse{" +
            ...
            ", codeTypeAdresse='" + getCodeTypeAdresse() + "'" +
