...
import { sampleWithRequiredData } from '../taux.test-samples';
...
describe('Taux Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.tauxes()[0]).toEqual(expect.objectContaining({ id: 25175 }));
  });

  describe('trackId', () => {
    it('should forward to tauxService', () => {
      const entity = { id: 25175 };
      jest.spyOn(service, 'getTauxIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTauxIdentifier).toHaveBeenCalledWith(entity);
